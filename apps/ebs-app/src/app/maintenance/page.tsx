  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-background py-16">
      ...
      <div className="relative z-10 space-y-8 px-4 text-center">
        <motion.h1
          className="flex items-center text-9xl font-extrabold text-foreground relative"
          initial={{ y: -50, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.5 }}
        >
          <Wrench size={16} className="size-36" />
          <div className="inline-flex">Under Maintenance</div>
          <motion.span
            animate={{ rotate: 360 }}
        ...
        >
          This site is under maintenance to give you a better experience
        </motion.h2>
        <motion.div
