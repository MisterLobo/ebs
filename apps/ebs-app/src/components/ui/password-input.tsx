...
export function PasswordInput({
  ...
  children?: ReactNode,
  onCheckPasswordStrength?: (strong: boolean) => void,
}) {
  ...
  const strength = checkStrength(inputProps?.value as string)
  ...
  useEffect(() => {
    if (onCheckPasswordStrength)
      onCheckPasswordStrength(strengthScore > 4)
  }, [onCheckPasswordStrength, strengthScore])
