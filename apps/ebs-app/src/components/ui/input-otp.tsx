...
const InputOTPWrapper = React.forwardRef<
  React.ComponentRef<"div">,
  React.ComponentPropsWithoutRef<"div">
>(({ ...props }, ref) => {
  return (
...
InputOTPWrapper.displayName = "InputOTPWrapper"

export { InputOTP, InputOTPGroup, InputOTPSlot, InputOTPSeparator, InputOTPWrapper }
