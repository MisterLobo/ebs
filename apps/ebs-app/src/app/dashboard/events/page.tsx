...
export default async function EventsPage() {
  ...
  const events = eventsData.map(event => ({
    ...
    opensAt: event.opens_at ? format(new Date(event.opens_at as string), 'P HH:mm') : '',
    deadline: event.deadline ? format(new Date(event.deadline as string), 'P HH:mm') : '',
    dateTime: event.date_time ? format(new Date(event.date_time as string), 'P HH:mm') : '',
